  ...
  <div class="main">
    <div class="main-box">
      ...
      <div class="description">
        <p>
        你可以在本版块查看所有的用户评论，并且超级管理员和普通管理员可以对非法评论进行删除操作， <i class="fa fa-trash fa-lg"></i> 表示批量删除。
        </p>
      </div> <!-- description -->
    </div> <!-- main-box -->

    <div class="main-box">
      <div class="box-title">留言列表
      ...
      <table class="fixed list">
        ...
        %>
            <tr>
              ...
              <td>中等</td>
              <td class="action">
              	<a href="admin/seeComment.jsp">查看</a><!--
              	--><a href="">删除</a>
              </td>
            </tr>
        <%
